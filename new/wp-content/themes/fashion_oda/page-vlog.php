...
<div class="bg_square">
	<header>
		<div class="wrap">
			<div class="head01">
				<p class="logo"><a href="<?php echo esc_url(home_url('/')); ?>" class="fade"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/vlog/logo.png" alt="織田ファッション専門学校"></a></p>
			...
			<nav class="gnavi">
				<ul class="main">
					...
					<li class="bnr"><a href="<?php echo esc_url(home_url('/')); ?>"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/vlog/logo_sp.png" alt="織田ファッション専門学校"></a></li>
				</ul>
			</nav>
		</div>
	</header>
	...
	<main>
		...
		<section class="sec_navi">
			<div class="wrap">
				<h2 class="ttl">ファッション学生の<span class="st">”<span class="green">REAL</span>”</span></h2>
				<ul class="link">
					<li><a href="#ranking" class="fade"><span class="en roboto">RANKING</span><span class="jp">(人気の動画)</span></a></li>
					<li><a href="#life" class="fade"><span class="en roboto">SCHOOL LIFE</span><span class="jp">(織田ファッションの日常)</span></a></li>
		...
		<section id="ranking" class="sec_ranking sec_slider is_anime fadein">
			...
			<?php
				...
				$youtube_channel_id = 'UCEYfHjtk0nDQBMO90FQS7Ig';
		...
		<section id="life" class="sec_life sec_slider is_anime fadein">
			<div class="wrap">
				<h2 class="ttl_sec"><span class="en roboto">SCHOOL LIFE</span>織田ファッションの日常</h2>
			...
			<div class="wrap">
				<div class="btn">
					<a href="<?php echo esc_url(home_url('/')); ?>oc/" class="fade">
						<p class="txt"><span>明日からのコーデが楽しくなる</span></p>
