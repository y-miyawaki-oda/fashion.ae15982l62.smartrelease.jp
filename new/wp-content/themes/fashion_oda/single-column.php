...
<div class="box_white_under">
	...
	<section class="sec_breadcrumb">
		<ul class="list">
			...
			<li><a href="<?php echo esc_url(get_post_type_archive_link("column")); ?>" class="fade">ファッションコラム</a></li>
			<li><?php the_title(); ?></li>
		</ul>
	</section>
	<!-- /.sec_breadcrumb -->
	<section class="sec_contents post-column">
			...
			<div class="column-1 mt80 sp-mt8">
				...
				<div class="btn-white mt80 sp-mt8"><a href="<?php echo esc_url(get_post_type_archive_link("column")); ?>" class="btn_type2 fade">ファッションコラム一覧へ</a></div>
			</div>
	<!-- /.sec_detail -->
		<?php if(get_field("sec_opencampus")): ?>
			...
			<div class="column-3 sp-column-2 column-h-center">
				<div>
					<a href="<?php echo esc_url(home_url('/')); ?>oc/" class="a-block">
						<div class="image-bg-line">
							<div class="image"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/academics/fukushuku/img_06_1.jpg" alt=""></div>
						</div>
				...
				<div>
					<a href="<?php echo esc_url(home_url('/')); ?>oc/" class="a-block">
						<div class="image-bg-line">
							<div class="image"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/academics/fukushuku/img_06_2.jpg" alt="">></div>
						</div>
