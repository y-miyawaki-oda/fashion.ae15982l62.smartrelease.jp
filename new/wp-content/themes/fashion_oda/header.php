...
<?php
	if(is_post_type_archive("news")) {
		$description = "織田ファッション専門学校のニュースや各種ご案内等を一覧形式で掲載しています。";
	}
	...
	<header>
		...
		<?php if(is_front_page()): ?>
			<h1 class="logo"><a href="<?php echo esc_url(home_url('/')); ?>" class="fade">
				<img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/common/logo_pc.png" alt="織田ファッション専門学校" class="pc">
				<img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/common/logo_sp.png" alt="織田ファッション専門学校" class="sp">
			</a></h1>
		<?php else: ?>
				...
				<ul class="main">
					...
					<li class="hoverbtn">
						...
						<div class="hovermenu">
							<div class="wrap">
								<ul class="children">
									<li><a href="<?php echo esc_url(home_url('/')); ?>academics/design/" class="fade">ファッションデザイン科</a></li>
									<li><a href="<?php echo esc_url(home_url('/')); ?>academics/fashiontechnical/" class="fade">ファッションテクニカル科</a></li>
									<li><a href="<?php echo esc_url(home_url('/')); ?>academics/stylist/" class="fade">スタイリスト科</a></li>
									<li><a href="<?php echo esc_url(home_url('/')); ?>academics/business/" class="fade">ファッションビジネス科</a></li>
					...
					<li class="hoverbtn">
						...
						<div class="hovermenu">
							<div class="wrap">
								<ul class="children">
									<li><a href="<?php echo esc_url(home_url('/')); ?>life/talk/" class="fade">ファッション学生にインタビュー！</a></li>
									<li><a href="<?php echo esc_url(home_url('/')); ?>vlog/" class="fade">oda fashion Vlog</a></li>
									<li><a href="<?php echo esc_url(home_url('/')); ?>life/campusreport/" class="fade">キャンパスレポート</a></li>
