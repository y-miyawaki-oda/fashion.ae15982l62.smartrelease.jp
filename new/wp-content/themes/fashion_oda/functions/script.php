<?php
	...
	function add_files() {
		...
		elseif(is_page("vlog")) {
			...
			wp_enqueue_style('c-perfect-scrollbar', get_template_directory_uri().'/css/perfect-scrollbar.css', array('c-font04'), '1.0', 'all');
			wp_enqueue_style('c-slick', get_template_directory_uri().'/css/slick.css', array('c-perfect-scrollbar'), '1.0', 'all');
			if(is_page("voice")) {
			...
			wp_enqueue_style('c-parts', get_template_directory_uri().'/css/parts.css', array('c-common'), '1.0', 'all');
			wp_enqueue_style('c-fashion', get_template_directory_uri().'/css/fashion.css', array('c-parts'), '1.0', 'all');
			...
			if(is_page()) {
				if(have_rows("css")) {
					...
					if(is_page("howto")) {
						wp_enqueue_style('c-page', get_template_directory_uri().'/css/howto.css', array('c-fashion'), '1.0', 'all');
					}
					else {
						wp_enqueue_style('c-page', get_template_directory_uri().'/css/'.get_toplevel_page_name().'.css', array('c-fashion'), '1.0', 'all');
					}
				}
			}
			elseif(is_post_type_archive(array("talk", "campusreport")) || is_singular(array("talk", "campusreport"))) {
				wp_enqueue_style('c-page', get_template_directory_uri().'/css/life.css', array('c-fashion'), '1.0', 'all');
			}
			elseif(is_post_type_archive() || is_single()) {
				$post_type = get_query_var('post_type');
				wp_enqueue_style('c-page', get_template_directory_uri().'/css/'.$post_type.'.css', array('c-fashion'), '1.0', 'all');
			}
			elseif(is_tax("cat_news")) {
				wp_enqueue_style('c-page', get_template_directory_uri().'/css/news.css', array('c-fashion'), '1.0', 'all');
			}
			elseif(is_tax("contestdate")) {
				wp_enqueue_style('c-page', get_template_directory_uri().'/css/coordinatecontest.css', array('c-fashion'), '1.0', 'all');
			}
		}
...
//			wp_deregister_script('jquery');
		...
		elseif(is_page("vlog")) {
			...
			wp_enqueue_script('s-perfect-scrollbar', get_template_directory_uri().'/js/perfect-scrollbar.min.js', array('s-ofi'), '1.0', true);
			wp_enqueue_script('s-slick', get_template_directory_uri().'/js/slick.min.js', array('s-perfect-scrollbar'), '1.0', true);
