		...
		<footer<?php if(is_page(array("confirm", "thanks"))) echo ' class="pb00"'; ?>>
			...
			<div class="footer_sns">
				<div class="wrap">
					<p class="ttl">SNS</p>
					<ul class="list">
						<li><a href="https://www.instagram.com/odafashioncollege/" class="fade" target="_blank"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/common/sns_insta.png" alt="instagram"></a></li>
						<li><a href="https://line.me/R/ti/p/%40740sxysj" class="fade" target="_blank"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/common/sns_line.png" alt="line"></a></li>
						<li><a href="https://www.youtube.com/channel/UCaB8sgFhDjyZ_HcwQV_1zEA" class="fade" target="_blank"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/common/sns_youtube.png" alt="youtube"></a></li>
					</ul>
				</div>
			</div>
	...
	<?php endif; ?>
	<?php if(is_page(array("design", "fashiontechnical", "stylist", "business", "fashiondesign_s", "fasiontechnical_s", "merchandising", "guidance", "tuition", "foreignstudentguideline", "tuitionsupport"))): ?>
	<script>
